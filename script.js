(function() {
  ...
  const translations = {
    ...
    tr: {
      ...
      "about.p1": "Yani, 16 yaşında bir pentester ve yazılım geliştiricisiyim. Küçüklüğümden beri bilgisayarlarla ilgileniyorum; özellikle donanım ve yazılım köprüleri, sosyal medya algoritmaları ve insanların telefonları üzerinden nasıl takip edildiği gibi konularla. Her sistemin bir açığı olabileceğini fark ettim ve açıkçası bu açıkların ortaya çıkması beni mutlu ediyor, çünkü istesek de en azından bir miktar kontrolün hâlâ elimizde olması güzel bir his; bu yüzden exploit geliştirmeye ve PoC yazmaya başladım. Yazdığım iskeletler ve algoritmalar için yapay zekayı kullanıyorum, böylece temiz bir kod yapısına ve dokümantasyona (README.md gibi) dönüşüyorlar; aynı zamanda yapay zekaya alışıyorum ve AI açıkları, sansürsüz AI, LLM'ler ve Prompt Injection gibi konulara da ilgi duyuyorum. Açık kaynağın insanların hakkı olduğunu düşünüyorum ve gerçek-sanal ortamlarda bunun için bir şeyler yapmaya çalışıyorum. Bu arada bence en iyi kahve caramel macchiato :l. Yarı insan yarı uzaylıyım, neden olmasın. Türkiye benim evim. Çoğu gece astral seyahat programları yazıyorum ve kapalı kaynak kod yazan şirketlerin kodlarını siliyorum. Ayrıca biraz denizaslanına benziyorum, tek farkım kod yazmam :v, bir gün herkes açık kaynak kullanacak ve denizaslanlarını sevecek.",
